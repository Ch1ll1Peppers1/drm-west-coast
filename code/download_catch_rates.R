...
download_catch_rates = function( survey="Eastern_Bering_Sea", add_zeros=TRUE, species_set=10, error_tol=1e-12, localdir=NULL, measurement_type="biomass" ){
  ...
  survey = switch( survey, "Vancouver_Island"="WCVI",
                   ...
                   "NBS"="NBSBTS",
                   "WCGBTS_2021-2024"="WCGBTS_2021-2024",
                   "West_coast_triennial"="WCT",
                   "WCT"="WCT", "WCGBTS_2019"="WCGBTS_2019",
                   "WCGBTS_2018"="WCGBTS_2018",
  ...
  # Add zeros
  if( add_zeros==TRUE & survey%in%c("WCGBTS_2019","WCGBTS_2021-2024","WCGHL","EBSBTS","GOABTS","AIBTS","NBSBTS","BSslope","WCVI","WCHG","QCS") ){
